    ...
    return (
      <header>
        ...
        <div style={{
          ...
          width: '80px',
          height: '80px'}}>
          <a target="_blank" rel="noopener noreferrer" href="https://github.com/Sehnsucht-codeCabin/emoweather" className={styles.githubCorner} aria-label="View source on GitHub">
            <svg
              width="80"
              height="80"
              viewBox="0 0 250 250"
              style={{
                fill: '#151513', color: '#fff', position: 'absolute', top: '0px', right: '0px', border: '0px',
              }}
              aria-hidden="true"
            >
